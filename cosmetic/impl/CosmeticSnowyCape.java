package base.cosmetic.impl;

import base.cosmetic.CosmeticBoolean;
import base.util.ui.AnimatedResourceLocation;
...
public class CosmeticSnowyCape implements LayerRenderer<AbstractClientPlayer>
{
    ...
    static {
        CosmeticSnowyCape.CAPEANIMATED = new AnimatedResourceLocation("client/animatedcapes/snowcape", 10,10);
    }
